...
var JobManager = module.exports = function JobManager(options) {
  ...
  this.processTemplate = !options.coin.isRavenProtocol ? function (rpcData) {
  ...
  this.processShare = !options.coin.isRavenProtocol ? function(jobId, previousDifficulty, difficulty, extraNonce1, extraNonce2, nTime, nonce, ipAddress, port, workerName, versionMask, isSoloMining) {
    ...
    } : function (miner_given_jobId, previousDifficulty, difficulty, miner_given_nonce, ipAddress, port, workerName, miner_given_header, miner_given_mixhash, extraNonce1, callback_parent) {
